...
vcom -work work {../src/multiplier/fpmul_pipeline_inreg_finegrain_mbe.vhd}
vcom -work work {../tb/data_sink_inreg_finegrain_mbe.vhd}
vlog -work work {../tb/tb_fpmul_inreg_finegrain_mbe.v}

vsim work.tb_fpmul_inreg_finegrain_mbe

add wave -noupdate -divider {Clock Generate}
add wave -noupdate -radix decimal /tb_fpmul_inreg_finegrain_mbe/CG/*
add wave -noupdate -divider {Data Maker}
add wave -noupdate -radix hexadecimal /tb_fpmul_inreg_finegrain_mbe/DM/*
add wave -noupdate -divider {UUT}
add wave -noupdate -radix hexadecimal /tb_fpmul_inreg_finegrain_mbe/UUT/*
add wave -noupdate -divider {Data Sink}
add wave -noupdate -radix hexadecimal /tb_fpmul_inreg_finegrain_mbe/DS/*
